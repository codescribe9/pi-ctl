...
app.get('/pi/video/:vid/:num', PiesController.playVideo)
...
app.get('/pi/shutdownMaster', PiesController.shutdownMaster)
app.get('/pi/rebootMaster', PiesController.rebootMaster)
